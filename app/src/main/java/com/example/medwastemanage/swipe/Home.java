...
import com.example.medwastemanage.Covid.SignupActivity;
...
public class Home extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        models.add(new Model(R.drawable.corona, "Covid19 Pandemic", "This app will help us to prevent the spread of Covid19 disease by dumping the infectious equipment " +
                ...
                " "));
        models.add(new Model(R.drawable.spread, "", "We well known about the rapid spread of the viruse which is capable of spreading exponetially" +
